...
\supervisor{\textsc{Juan Manuel Moreno Lamparero}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{\textsc{José María Sánchez Salas}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
{\scshape\huge \degreename\par} \vspace{0.5cm} % Degree name 
